...
if($_SERVER['REQUEST_METHOD']== 'POST')
{
  ...
  $photo=$_POST['photo'];
  // $photo = $_FILES['photo']['tmp_name']; // Temporary location of the uploaded file
  // $photoContent = file_get_contents($photo); // Read the file content
  // $photoBase64 = base64_encode($photoContent); // Convert the content to base64
  $msg=$_POST['msg'];
  $email=$_POST['email'];
