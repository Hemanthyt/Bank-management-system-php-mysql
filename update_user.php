...
<body>
    <div class="data">
        <form  method="POST" enctype="multipart/form-data">
            <center><h3 id="title">Details From Customers</h3></center> 
            <hr>
            <?php 
                            ...
                            <div class="card-body">
                                <table class="table table-bordered text-center">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn" name="id" disabled>
                                                <a style="text-decoration:None;" href="request_delete.php?id=<?php echo $row['SI_no']; ?>&field=<?php echo $row['FieldName'] ?>&acc=<?php echo $row['AccountNumber'] ?>&old=<?php echo $row['ExistingValue'] ?>&new=<?php echo $row['NewValue'] ?>">Update</a>
                                            </button>
                                        </td>
                                    </tr>
                                </table>
